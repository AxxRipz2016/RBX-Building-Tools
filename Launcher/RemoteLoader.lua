...
local TOOL_SOURCE_FINGERPRINTS: { [string]: string } = {
	["Tools/Rotate.lua"] = "BT_ROTATE_REV=141",
	["Tools/Move/HandleDragging.lua"] = "BT_MOVE_REV=141",
	["Tools/Move/FreeDragging.lua"] = "BT_MOVE_REV=141",
	["Tools/Anchor.lua"] = "BT_TOOLS_REV=141",
	["Tools/Collision.lua"] = "BT_TOOLS_REV=141",
	["Tools/NewPart.lua"] = "BT_TOOLS_REV=141",
}
