...
local TOOL_SOURCE_FINGERPRINTS: { [string]: string } = {
	["Tools/Rotate.lua"] = "BT_ROTATE_REV=147",
	["Tools/Move/HandleDragging.lua"] = "BT_MOVE_REV=147",
	["Tools/Move/FreeDragging.lua"] = "BT_MOVE_REV=147",
	["Tools/Anchor.lua"] = "BT_TOOLS_REV=147",
	["Tools/Collision.lua"] = "BT_TOOLS_REV=147",
	["Tools/NewPart.lua"] = "BT_TOOLS_REV=147",
}
